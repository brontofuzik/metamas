...
SET PARTICIPANT1_PLAYER=participant1_Player:%PLAYER_PACKAGE%.Participant1_Player
SET PARTICIPANT2_PLAYER=participant2_Player:%PLAYER_PACKAGE%.Participant2_Player
SET PARTICIPANT3_PLAYER=participant3_Player:%PLAYER_PACKAGE%.Participant3_Player
