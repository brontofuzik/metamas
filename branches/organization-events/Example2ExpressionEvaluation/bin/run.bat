...
SET CALCULATOR1_PLAYER=calculator1_Player:%PLAYER_PACKAGE%.Calculator1_Player
SET CALCULATOR2_PLAYER=calculator2_Player:%PLAYER_PACKAGE%.Calculator2_Player
SET CALCULATOR3_PLAYER=calculator3_Player:%PLAYER_PACKAGE%.Calculator3_Player
SET CALCULATOR4_PLAYER=calculator4_Player:%PLAYER_PACKAGE%.Calculator4_Player
SET CALCULATOR5_PLAYER=calculator5_Player:%PLAYER_PACKAGE%.Calculator5_Player
